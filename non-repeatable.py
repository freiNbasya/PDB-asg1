...
print(f"NON-REPEATABLE READ(before commit): Amount of apples = {cursor2.fetchone()[0]}")

first_connection.commit()

cursor2.execute("SELECT amount from fruits WHERE fruit_name = 'apple';")
print(f"NON-REPEATABLE READ(after commit): Amount of apples = {cursor2.fetchone()[0]}")
